...
<div class="container">
    ...
    <form action="/submit" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" style="margin-left: 0" type="checkbox" name="hobby" id="read">
                    <label class="form-check-label">看书</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" style="margin-left: 0" type="checkbox" name="hobby" id="movie">
                    <label class="form-check-label">看电影</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" style="margin-left: 0" type="checkbox" name="hobby" id="exercise">
